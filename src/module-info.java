 ...
 * and in general factories are involved with creational stuff and here with this an object is being created. 
 * It is one of the best ways to create an object where object creation logic is hidden to the client. Now Let’s look at the implementation.
 ...
 * and so this Factory method is also called as Virtual constructor.
 *  Let’s try to implement it with a real-time problem and some coding exercise.
 * 
 */
/**
 * @author Mahesh
 *
 */
module FactoryMethodDesignPattern {
